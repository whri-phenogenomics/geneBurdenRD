...
#BSUB -cwd /re_gecip/enhanced_interpretation/lvestito/gene_burden/geneBurdenRD
#BSUB -n 5
...
# args[2]. path for Exomiser masterfile file: e.g. "data/exomiser_master_file_final_01_12_23.tsv"
...
Rscript /re_gecip/enhanced_interpretation/lvestito/gene_burden/geneBurdenRD/scripts/geneBurdenRD_visualisation_jobarray.R 'LSB_JOBINDEX' "/re_gecip/enhanced_interpretation/dsmedley/exomiser_master_file_final_01_12_23.tsv" "data/analysisLabelList.tsv" "0.05" "plot"
